class Twitter < ActiveRecord::Base
  ...
  #   twitter_user = HTTParty.get("https://api.github.com/user", { :body => {}, :headers => {"authorization" => "token #{twitter_authentication.token}", "User-Agent" => "SuperFeed"} })
  #   twitter_username = github_user["login"]
  #   twitter_response = HTTParty.get("https://api.github.com/users/#{github_username}/received_events", { :body => {}, :headers => {"authorization" => "token #{github_authentication.token}", "User-Agent" => "SuperFeed"} })
